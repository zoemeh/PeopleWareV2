                    ...
                    <div class="p-1.5 min-w-full inline-block align-middle">
                        <div class="overflow-hidden">
                            <form wire:submit.prevent="save">
                                ...
                                <input type="text" id="nombre" name="nombre" wire:model="candidato.nombre"
                                ...
                                <input type="text" id="cedula" name="cedula" wire:model="candidato.cedula"
                                    class="mb-2 py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                                <label for="salario_deseado"
                                    class="block text-sm font-medium mb-2 dark:text-white">salario_deseado</label>
                                <input type="text" id="salario_deseado" name="salario_deseado" wire:model="candidato.salario_deseado"
                                    class="mb-2 py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                                <button type="submit"
